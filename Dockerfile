...
EXPOSE 18970
CMD ["serve", "--port", "18970", "--allow-read=dist,server/router/route,datakv.db,log", "--allow-write=datakv.db,log", "--allow-env=APP_DB_PREFIX,SL_REQUEST_SIGN_KEY,ALLOW_SL_USER_AGENT_PART,SL_ADMIN_LIST", "server/api.ts"]
